...
(function () {
  ...
  function exame(id, tipo, lab, data, params, resumo, origemLab) {
    ...
    return {
      ...
      // a miniatura é a foto do laudo de verdade
      arquivoUrl: LAUDO_REAL,
